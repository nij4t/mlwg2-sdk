...
user=`nvram get 2860 3g_user`
pass=`nvram get 2860 3g_pass`
apn=`nvram get 2860 3g_apn`
pin=`nvram get 2860 3g_pin`
HTBW=`nvram get 2860 WIFIHTBW`
Channel=`nvram get 2860 WIFIChannel`
if [ "$dev" != "OPTION-ICON225" ]; then
	echo "Start 3G WAN Link!!"
	link_detect 3G
