...
#define MAX_QOS_EVENTS_PER_BUCKET 24    /* protocol spec recommends 82 as max, 24 as minimum; WARNING: must be power of 2 */ /*Catherine 32 to 24*/
typedef struct {
...
#define MAX_QOS_BUCKETS 4               /* WARNING: must be power of 2 */ /*Catherine 8 to 4 */
typedef struct {
    ...
    /* QosDiags sessions */
#define MAX_QOS_SESSIONS 4 /*Catherine 10 to 4*/
