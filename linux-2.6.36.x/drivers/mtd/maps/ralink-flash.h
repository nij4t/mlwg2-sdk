...
#define MTD_JFFS2_PART_SIZE 0x50000
#endif
// --- Gemtek
...
#define MTD_ROOTFS_PART_SIZE	IMAGE1_SIZE - (MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
                                        + MTD_FACTORY_PART_SIZE + CONFIG_MTD_KERNEL_PART_SIZ + MTD_JFFS2_PART_SIZE)
#else /* CONFIG_JFFS2_FS */
#define MTD_ROOTFS_PART_SIZE	IMAGE1_SIZE - (MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE \
					+ MTD_FACTORY_PART_SIZE + CONFIG_MTD_KERNEL_PART_SIZ)
#endif /* CONFIG_JFFS2_FS */
// --- Gemtek
...
#define IMAGE1_SIZE		0xfb0000 // 16M flash
// --- Gemtek
#endif
#endif
